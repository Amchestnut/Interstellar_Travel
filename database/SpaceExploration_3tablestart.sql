...
(name, type, researched, mean_distance_from_star, lowest_temperature, highest_temperature, oxygen_percentage, other_gas_percentage, gravitational_field_height, orbital_speed) VALUES
    ...
    ('Alpha OMEGA HABITABLE', 'Planet', 1, 160, 200, 300, 20, 75, 999, 30),
    ...
    ('Nova Terra', 'Planet', 1, 180, 190, 300, 20, 75, 100, 32),
    ('Aurora Prime', 'Planet', 1, 125, 170, 290, 21, 78, 100, 30),
    ('Caelus', 'Planet', 1, 140, 180, 280, 20, 78, 100, 31),
    ('Seraphine', 'Planet', 1, 115, 160, 270, 18, 80, 100, 27),
    ('Blue Haven', 'Planet', 1, 130, 190, 300, 17, 75, 100, 29),
    ('Matejina Utopija', 'Planet', 1, 180, 220, 310, 20, 75, 120, 30),
    ('Elara', 'Planet', 1, 150, 200, 310, 16, 79, 10000, 33),
    ('Persephone', 'Planet', 1, 190, 230, 310, 17, 78, 100, 29),
    ('Astraea', 'Planet', 1, 180, 200, 300, 20, 75, 120, 30),
    ('Nostromo', 'Planet', 1, 195, 205, 315, 21, 74, 1440, 27);
